	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.btnZero.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ApplicationController
						.handleRequest(numKey, btnNumber, txtInput);
		...
		this.btnDecimal.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (counter == -1) {
					...
					ApplicationController.handleRequest(numKey, btnNumber,
							txtInput);
				}
		...
		this.btnSubtract.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ApplicationController.handleRequest(command, activity,
						txtInput, txtSolution);
				command = opperand;
			}
		});
